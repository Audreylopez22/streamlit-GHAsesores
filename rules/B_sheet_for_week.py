...
def create_table(sheet, week_data):
    ...
    sheet.append(["Colaborador", "Salario", "Hr laboradas","Hr Rec nocturnas","Rec pago nocturnas", "Hr Rec dia Dom-Fest ","Rec pago dia Dom-Fest ","Hr Rec Noche Dom-fes","Rec pago noche Dom-fest","Hr extra dia","Hr pago extra dia", "Hr extra Noche","Hr pago extra noche","Hr extra día Dom-fes","Hr pago extra día Dom-fes","Hr extra noche Dom-fes","Hr pago extra noche Dom-fes", "Total Sem"])
    ...
    for employe_name, employe_info in week_data.items():
        ...
        sheet.append([employe_name, salary, total_hours,night_surchage_hours,night_surchage_pay,day_holidays_surcharges_hours,day_holidays_surchage_pay, night_holidays_surcharges_hours, night_holidays_surchage_pay,daytime_overtime_hours, daytime_overtime_pay,night_overtime_hours,night_overtime_pay,daytime_holidays_hours,daytime_holidays_pay, night_holidays_overtime_hours,night_holidays_overtime_pay,total_sem])
